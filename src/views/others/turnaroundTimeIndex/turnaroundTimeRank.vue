<template>
  ...
  <div id="turnaroundTimeRank">
    ...
    <div class="head"><span>{{ typeMap+ "(" + week + ")"  }}</span></div>
    <div class="lis">
...
#turnaroundTimeRank {
  width: 100%;
  min-height: 100vh;
  background: url("https://www.yunzmall.com/min_img/turnaroundTimeRankBJ.png");
        ...
        .lisUser {
          ...
          .left {
            ...
            .noOne {
              width: 41px;
              height: 44px;
              background-image: url("https://www.yunzmall.com/min_img/turnaroundTimeRankone.png");
            ...
            .noTwo {
              width: 41px;
              height: 44px;
              background-image: url("https://www.yunzmall.com/min_img/turnaroundTimeRanktwo.png");
              background-size: 220% 220%;
              background-position: center;
              margin-right: 10px;
            }
            .noThr {
              width: 41px;
              height: 44px;
              background-image: url("https://www.yunzmall.com/min_img/turnaroundTimeRankthr.png");
              background-size: 220% 220%;
              background-position: center;
              margin-right: 10px;
            }
