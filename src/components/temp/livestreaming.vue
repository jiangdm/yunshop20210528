...
<template>
  <div id="livestreaming" :style="{ backgroundColor: datas.params.livebgcolor }">
    <van-tabs
      ...
      swipeable
      @change="getData"
      :background="datas.params.bgcolor"
      :title-active-color="datas.params.selectedcolor"
      :color="datas.params.selectedcolor"
      :title-inactive-color="datas.params.wordcolor"
    >
              ...
              >
                ...
                <div class="top">
                  ...
                  ><template v-if="item.status == '2'">
                    <!-- < :time="item.live_time" timetype="timestamp" done-text="等待开播"></> -->
...
export default {
  ...
  computed: {},
  mounted() {
    let _activeType = this.datas.params.type || '0';
    this.getData(_activeType.toString());
    this.getShowBack();
  },
  activated() {
    // this.getData();
