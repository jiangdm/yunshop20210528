      ...
      <div class="month_box" v-for="(item, index) in date_obj_arr" :key="index">
        ...
        <div class="month">
          <ul class="row">
            ...
            <!--              {{ day_item.value }}-->
            <!--            </li>-->
            <div v-for="(day_item, day_index) in item.day" :key="day_index">
              <li v-if="day_item.isOld == '0'" :key="day_index"
              ...
              }}</span><span v-if="(day_item.is_manfang&&day_item.is_manfang==1)">{{ day_index == d_index && index == m_index ? "" : "满房"}}</span><span
                v-if="(day_item.vprice&&day_item.is_manfang!=1)">{{day_index == d_index && index == m_index ? "" : day_item.vprice
              }}</span>
              </li>
              <li
                v-if="day_item.isOld == '-1'"
