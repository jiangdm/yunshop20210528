              ...
              <div class="title-box">
                ...
                <h2>
                  <van-col :span="24" id="price" v-if="!isGoodsLove">
                    <div class="point-good" v-if="goods_plugin.point_goods">
                    ...
                    <div class="show_price_box" v-else-if="goods_plugin.goods_show && goods_plugin.goods_show.goods_detail_style == 1">
          ...
          <div class="act-box">
            ...
            <ul class="act" @click="gotohuiyuan" v-if="goods_plugin.selfbuy_discount" style="height: auto; align-items: center;">
              ...
              <li class="act2" style="height: auto;">
                <div v-if="goods_plugin.selfbuy_discount.this_level_discount_price.show == 1">{{ goods_plugin.selfbuy_discount.this_level_discount_price.content }}</div>
                <div v-if="goods_plugin.selfbuy_discount.next_level_discount_price.show == 1">{{ goods_plugin.selfbuy_discount.next_level_discount_price.content }}</div>
              </li>
              <li class="act3">
                <span></span>
              </li>
              <li class="act3"><span></span></li>
              <i class="fa fa-angle-right" v-if="goods_plugin.selfbuy_discount.link_to_level_page && goods_plugin.selfbuy_discount.link_to_level_page.show == 1"></i>
            </ul>
            <!-- 自购省end -->
            ...
            <ul class="iconBox" v-if="labelList.length > 0">
              <li v-for="(item, pindex) in labelList" :key="pindex"><img v-if="item.pic" :src="item.pic" alt="" />{{ item.word }}</li>
            </ul>
          </div>
          <!-- 运费插件 -->
...
"
      ...
      <van-popup v-model="popupSpecs" :style="{ overflow: 'visible' }" position="bottom" class="mint-popup-4 pcStyle_mint" closeOnClickModal="true">
        <div class="specifications">
          ...
          <div class="shopimg">
            ...
            <div class="right">
              <div class="price" v-if="goods_plugin.point_goods">
          ...
          <van-cell-group style="border-width: 0;">
            <div v-for="(item, i) in activityArr" :key="i" style=" text-align: left; padding: 0 0.875rem;">
              <van-cell style="padding: 0.625rem 0;">
                ...
                <template #right-icon>
                  <span slot="right" v-if="item.type == 'string'" style="color: #333; font-size: 13px; text-align: right;">{{ item.value }}</span>
                  <span slot="right" v-if="item.type == 'array'" style="color: #333; font-size: 13px; text-align: right;">
                    <span>
      ...
      <div id="foot">
        <!--增加DistributionGoods判断-->
        <template v-if="route_type !== 'DistributionGoods'">
          <!--供应商-->
