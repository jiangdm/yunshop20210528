...
export default {
  ...
  data() {
    return {
      ...
      route_type: '', // 根据路由判断商品类型 例如DistributionGoods
  ...
  activated() {
    if(this.$route.name === 'DistributionGoods') {
      this.route_type = this.$route.name;
    }
  ...
  methods: {
    ...
    getGoodsPage(data) {
      ...
      if (this.goods_plugin.pack_fixed_price && this.goods_plugin.pack_fixed_price.id) {
        this.pack_price = this.goods_plugin.pack_fixed_price.pack_price;
        this.goods_count = this.goods_plugin.pack_fixed_price.goods_count;
        this.ActivityId = this.goods_plugin.pack_fixed_price.id;
    ...
    setIsLove() {
      if (this.goods_plugin.goods_love) {
        ...
        //this.goods_love_cash = (this.goodsInfo.price - this.goods_plugin.goods_love.love_coin.amountOfMoney);
