...
<style scoped>
    ...
    .icon-down-background { display: inline-block; width: 1.25rem; height: 1.25rem; background: no-repeat 50%; background-image: url('../assets/load-down.png'); background-size: 1rem; vertical-align: middle; -webkit-transition-duration: 0.3s; transition-duration: 0.3s; }
    .icon-up-background { display: inline-block; width: 1.25rem; height: 1.25rem; background: no-repeat 50%; background-image: url('../assets/load-down.png'); background-size: 1rem; vertical-align: middle; transform: rotate(180deg); -webkit-transition-duration: 0.3s; transition-duration: 0.3s; }
    .pull-to-refresh { width: 100%; color: #a1a1a1; text-align: center; }
    .scroll-to-top { -webkit-transition-duration: 0.3s; transition-duration: 0.3s; }
